...
package com.pharmacy.pharmacymanagement.Controller;
...
import com.pharmacy.pharmacymanagement.Database.DatabaseCon;
import com.pharmacy.pharmacymanagement.Models.CustomerModel;
import com.pharmacy.pharmacymanagement.Models.MedicineModel;
import com.pharmacy.pharmacymanagement.Models.getData;
...
public class MainController implements Initializable {
    ...
    @FXML
    private TableView<MedicineModel> addMedicines_tableView;
    
    @FXML
    private TableColumn<MedicineModel, String> addMedicines_col_medicineID;

    @FXML
    private TableColumn<MedicineModel, String> addMedicines_col_brand;

    @FXML
    private TableColumn<MedicineModel, String> addMedicines_col_productName;

    @FXML
    private TableColumn<MedicineModel, String> addMedicines_col_type;

    @FXML
    private TableColumn<MedicineModel, String> addMedicines_col_price;

    @FXML
    private TableColumn<MedicineModel, String> addMedicines_col_status;

    @FXML
    private TableColumn<MedicineModel, String> addMedicines_col_date;
    ...
    @FXML
    private TableView<CustomerModel> purchase_tableView;

    @FXML
    private TableColumn<CustomerModel, String> purchase_col_medicineId;

    @FXML
    private TableColumn<CustomerModel, String> purchase_col_brand;

    @FXML
    private TableColumn<CustomerModel, String> purchase_col_productName;

    @FXML
    private TableColumn<CustomerModel, String> purchase_col_type;

    @FXML
    private TableColumn<CustomerModel, String> purchase_col_qty;

    @FXML
    private TableColumn<CustomerModel, String> purchase_col_price;
...
//    DATABASE TOOLS
    ...
    public ObservableList<MedicineModel> addMedicinesListData(){
        
        String sql = "SELECT * FROM medicine";
        
        ObservableList<MedicineModel> listData = FXCollections.observableArrayList();
        ...
        try{
            ...
            MedicineModel medData;
            
            while(result.next()){
                medData = new MedicineModel(result.getInt("medicine_id"), result.getString("brand")
    ...
    private ObservableList<MedicineModel> addMedicineList;
    ...
    public void addMedicineSearch(){
        ...
        FilteredList<MedicineModel> filter = new FilteredList<>(addMedicineList, e-> true);
        
        addMedicines_search.textProperty().addListener((Observable, oldValue, newValue) ->{
            
            filter.setPredicate(predicateMedicineModel ->{
                ...
                if(predicateMedicineModel.getMedicineId().toString().contains(searchKey)){
                    return true;
                }else if(predicateMedicineModel.getBrand().toLowerCase().contains(searchKey)){
                    return true;
                }else if(predicateMedicineModel.getProductName().toLowerCase().contains(searchKey)){
                    return true;
                }else if(predicateMedicineModel.getType().toLowerCase().contains(searchKey)){
                    return true;
                }else if(predicateMedicineModel.getStatus().toLowerCase().contains(searchKey)){
                    return true;
                }else if(predicateMedicineModel.getPrice().toString().contains(searchKey)){
                    return true;
                }else if(predicateMedicineModel.getDate().toString().contains(searchKey)){
                    return true;
                }else return false;
            });
        });
        
        SortedList<MedicineModel> sortList = new SortedList<>(filter);
    ...
    public void addMedicineSelect(){
        MedicineModel medData = addMedicines_tableView.getSelectionModel().getSelectedItem();
    ...
    public ObservableList<CustomerModel> purchaseListData(){
        purchaseCustomerId();
        ...
        try{
            ...
            while(result.next()){
                customerD = new CustomerModel(result.getInt("customer_id")
    ...
    private ObservableList<CustomerModel> purchaseList;
    ...
    public void logout() {
        ...
        try {
            ...
            if (option.get().equals(ButtonType.OK)) {
                ...
                Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/com/pharmacy/pharmacymanagement/login-view.fxml")));
